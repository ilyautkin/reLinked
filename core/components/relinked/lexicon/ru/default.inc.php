...
$_lang['relinked'] = 'Перелинковка сайта';
$_lang['relinked_menu_desc'] = 'Дополнение для быстрой перелинковки';
...
$_lang['relinked_item_err_url'] = 'Вы должны указать, на какую страницу поставить эту ссылку.';
$_lang['relinked_item_err_ae'] = 'Такая ссылка уже существует.';
...
$_lang['relinked_import'] = 'Импорт';
$_lang['relinked_import_msg'] = 'Выберите файл импорта у себя на компьютере.';
$_lang['relinked_import_start'] = 'Начать импорт';
$_lang['relinked_import_file_select'] = 'Выберите CSV-файл';
